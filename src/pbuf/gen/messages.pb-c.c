...
static const ProtobufCFieldDescriptor vdcapi__message__field_descriptors[26] =
{
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_MESSAGE,
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(Vdcapi__Message, vdsm_request_set_property),
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_MESSAGE,
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(Vdcapi__Message, vdc_send_identify),
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_MESSAGE,
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(Vdcapi__Message, vdsm_send_output_channel_value),
