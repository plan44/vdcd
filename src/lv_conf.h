...
#define LV_USE_LOG (DEBUG) // log for debug builds
//#define LV_USE_LOG 0
#if LV_USE_LOG
...
#define LV_ASSERT_HANDLER assert(false); /* do a platform assert */
